...
type Request struct {
	...
	// Everywhere else, this is "tls". Conains the logs from the configured grab TLS scan (TLS handshake, heartbleed check, etc) 
	TLSLog *grab.TLSLog `json:"tls_log,omitempty"`
