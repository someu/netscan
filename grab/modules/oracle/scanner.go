// Package oracle provides the grab scanner module for Oracle's TNS protocol.
...
func (scanner *Scanner) Scan(t grab.ScanTarget) (grab.ScanStatus, interface{}, error) {
	...
	if connectDescriptor == "" {
		...
		// purposes.
		connectDescriptor = "(DESCRIPTION=(CONNECT_DATA=(CID=(PROGRAM=grab))))"
	}
	...
	if err != nil {
		...
		case ErrUnexpectedResponse:
			return grab.SCAN_APPLICATION_ERROR, results, err
		default:
