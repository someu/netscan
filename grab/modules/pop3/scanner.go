// Package pop3 provides a grab module that scans for POP3 mail
// servers.
...
func RegisterModule() {
	var module Module
	_, err := grab.AddCommand("pop3", "pop3", module.Description(), 110, &module)
	if err != nil {
		log.Fatal(err)
	}
}
...
func VerifyPOP3Contents(banner string) grab.ScanStatus {
